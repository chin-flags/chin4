...
Now I'm trying to figure out why my button changes color to green when I click it, and I didn't code it that way!
...
I was fascinated by computers from the moment I got one, not just for watching movies and playing games, but also for experimenting, editing, and even creating small Flash games. I wanted to study Computer Engineering at university, and in Sri Lanka, we get free education up to a bachelor's degree. However, in our system, you select your discipline after the first year, based on your GPA.

Well, as you might have guessed by the title, I didn't get in! My GPA wasn't enough. I could blame my ignorance. I did not want to leave the degree as well, so I picked "Production Engineering" which had stuff like process, mechanical, and electronics, and a little bit of automation.
...
![](/images/me-covid.jpg)
> On duty during the COVID-19 pandemic: Medical gas engineering in action
...
During the initial few months of the COVID era (remember ? the virus, lockdowns, and other things), just before my country imposed lockdown, I met [Guillaume](https://x.com/GuiBibeau) most randomly via someone I knew for just 2 days in Discord. Gui was looking for a freelancer for a SaaS that he and some other folks were building. As my interview task, I was given the task to build a calculator without using any libraries. I built the weirdest calculator. During the interview, my microphone didn't work, so we started chatting with sign language, and I knew how to signal money and numbers with fingers, and he knew how to nod.
...
There could be multiple reasons. For me, it was that I felt stuck doing the same thing all over again. It felt like Groundhog Day. So life was just flat, so I wanted to pick up a fun habit, which turned into a profit after some time. 
...
Looking back, I didn't have a "goal" to break into building software. I have started to think that our lives are just random events that occur to us. Somehow, one thing leads to other things, and things go on. But we can make sense of everything in the end. Life can only be understood backwards, but it must be lived forwards. (said some dead p**hilosopher**). 

That does not mean we can just allow destiny or serendipity to consume our lives. So we could work toward our "goals" or "visions," but the expected result won't come, or it might come in the most unexpected ways. To make myself smarter, I am adding another quote. I don't know who said it, though. "Waking up early won't make the sun rise sooner. But it helps to be awake when it does."